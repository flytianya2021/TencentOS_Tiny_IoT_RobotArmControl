 ...
 *
 */
static char sg_product_id[MAX_SIZE_OF_PRODUCT_ID + 1] = "8IT0644V94";

/**
 * @brief device name
 *
 */
static char sg_device_name[MAX_SIZE_OF_DEVICE_NAME + 1] = "SmartCar_RobotArm";
 ...
 *
 */
static char sg_device_secret[MAX_SIZE_OF_DEVICE_SECRET + 1] = "mOAvDZcEgBFhz5pC7Uw2GA==";
#endif
